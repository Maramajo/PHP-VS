...
<?php endif; ?>
<form action="<?php echo site_url('users/admin_recover_user/' . $user['id_user']) ?>" method="post" class="  bg-light">
    <div class="row">
        <div class="col-y"></div>
        <div class="col-7">
            <h2>Recuperar ID</h2>
        ...
        <button class="btn btn-primary">Deveja reativar mesmo?</button>
        </div>
    </div>
